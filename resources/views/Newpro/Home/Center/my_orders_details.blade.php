...
<div class="contact_right">
        ...
        <div class="Order">
            <div class="state">@if( $data->status < 1 ) 未支付 @else 已支付 @endif</div>
            <div class="Speed">
            ...
            <div class="Shop">
                ...
                <div class="Shop_top da">
                    <div class="shop_loop">自定义套餐包</div>
                    <div class="shop_loop">{{ $data->name }}</div>
                    <div class="shop_loop">{{ 1 }}</div>
                    <div class="shop_loop">{{ $data->totals }}</div>
                </div>
                @foreach($data->detail as $k => $v)
                <div class="Shop_top">
                    <div class="shop_loop"></div>
