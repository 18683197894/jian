    ...
    <div class="content">
        ...
        <div class="Account">
            <form action="">
                ...
                <label id="label_2">
                    <input type="text" name="name" class="yans" value="" placeholder="用户名">
                    <span>用户名格式错误</span>
                    <span>该用户名已存在</span>
                </label>
                <label id="label_3">
                    <input type="password" class="yans" name="password" placeholder="密码">
                    <span>密码格式错误</span>
                </label>
                <label id="label_4">
                    <input type="text" class="yans" name="phone" placeholder="手机号">
                    <span >手机号格式错误</span>
                    <span >手机号已存在</span>
                </label>
                <label id="label_5">
