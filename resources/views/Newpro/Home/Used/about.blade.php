...
<div class="contact">
    ...
    <div class="Sorts">
        ...
        <!--发展战略-->
        <div class="Sorts_lower @if( $ors == 'strategy' ) avtive @endif">
            <div class="Strategy">
                不断完善平台服务，做家居行业最有价值的品牌，统一化，标准化，一体化，专业化服务。
                <br/>
                我们致力于打造一个千亿级的互联网家居企业，成为家居行业的标杆型服务平台。
                <div class="title">家居建材市场规模超4万亿，互联网渗透率低，潜力巨大！</div>
                <div class="zhanlui">
                    <div class="fl">
                        <img src="{{ asset('/new/home/about/img/zhanlui1.png') }}" alt=""/>
                        <span>2016年家居建材互联网渗透率</span>
                    </div>
                    <div class="fl">
                        <img src="{{ asset('/new/home/about/img/zhanlui2.png') }}" alt=""/>
                        <span>网购与o2o带动电商销售</span>
                    </div>
                    <div class="fl">
                        <img src="{{ asset('/new/home/about/img/zhanlui3.png') }}" alt=""/>
                        <span>互联网张背景下、家居建材线上销售</span>
                    </div>
                </div>
            </div>
            <div class="Economics">
                <div class="Economics_auto">
                    <img src="{{ asset('/new/home/about/img/Economics.jpg') }}" alt=""/>
                    <div class="text">
                        <span>经济效益明显</span>
                        <p>解决商家和消费者长期的矛盾和信息不对称问题，实现双方共赢</p>
                        <p>有效的对接社会闲散资源</p>
                        <p>有利于民生 </p>
                        <p>让共享经济在网上家居商城领域扎根</p>
                        <p>满足用户花最少的钱买到最好的产品及服务诉求</p>
                    </div>
                </div>
            </div>
            <div class="Promote">
                ...
                <img src="{{ asset('/new/home/about/img/dc1.jpg') }}" alt="" class="Promote_img"/>
            </div>
            <div class="Economics">
                <div class="Economics_auto">
                    <img src="{{ asset('/new/home/about/img/dc2.jpg') }}" alt=""/>
                    <div class="text">
                        <span>建商网发展项目</span>
                        <p>是现化服务业与传统行业相结合的新“引擎”</p>
                        <p>多种配套服务于一体</p>
                        <p>为消费者提供便利服务 </p>
                        <p>有利于提升市场竞争力和城市品位</p>
                        <p>改变交易市场零乱局面</p>
            ...
            <div class="Job">
                <div class="title">提高就业率</div>
                <div class="Job_text">
                    项目建成后会和各个建材家居商家互惠共赢，本项目可直接提供800个以上就业岗位，带动地方人才就业，带动地方经济发展完善地方产业，对地方建设具有较大积极作用。
                </div>
                <div class="Job_img">
                    <img src="{{ asset('/new/home/about/img/Job_img1.png') }}" alt=""/>
                    <img src="{{ asset('/new/home/about/img/Job_img2.png') }}" alt=""/>
                    <img src="{{ asset('/new/home/about/img/Job_img3.png') }}" alt=""/>
                    <img src="{{ asset('/new/home/about/img/Job_img4.png') }}" alt=""/>
                </div>
            </div>
        </div>
        <!--组织架构-->
