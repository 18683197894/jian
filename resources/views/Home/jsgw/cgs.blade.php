...
<div class="cg-zs"></div>
   ...
   <div class="cg-zsx">
		...
		<ul>
		    <li><img  data-original="{{ asset('home/images/cgs/cg-100.jpg') }}" /></li>
			<li><p>我们的产品</p><span>家居建材全品供货、加工、服务及物流与金融服务</span></li>
			<li><img  data-original="{{ asset('home/images/cgs/cg-101.jpg') }}" /></li>
		...
		<div class="cg-zs-p2"><img  data-original="{{ asset('home/images/cgs/cg-102.jpg') }}" width="390" height="290" /><b>平台优势</b><p>1、丰富的严选建材供应商<br>2、PC+移动端<br>3、大数据据推荐，搭建国内垂直建材采购平台</p></div>
		<div class="cg-zs-p3"><img  data-original="{{ asset('home/images/cgs/cg-103.jpg') }}" width="390" height="290" /><b>丰富的采购场景</b><p>1、便捷的平台化操作<br>2、满足企业普通采购和战略寻源<br>3、快速响应的点对点多样化采购场景</p></div>
		<div class="cg-zs-p4"><img  data-original="{{ asset('home/images/cgs/cg-104.jpg') }}" width="390" height="290" /><b>在线OA</b><p>1、需求管理  物流与监控<br>2、支付管理  招标询价  协议采购中心<br>3、订单管理  支付管理</p></div>
