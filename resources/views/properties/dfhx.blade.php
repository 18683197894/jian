...
@section('css')
	<link href="{{ asset('/home/images/dfhx/common.css') }}" rel="stylesheet" />
...
@section('content')
	...
	<ul id="pic_list">
        ...
        <a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/1.jpg')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/2.jpg')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/3.jpg')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/4.jpg')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/5.jpg')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/6.jpg')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/7.jpg')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/dfhx/8.jpg')}}" alt="" /></a></li>
	</ul>
	...
	<div id="ico_list">
		<ul>
			<li class="active"><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/dfhx/1.jpg')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/dfhx/2-2.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/dfhx/3-3.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/dfhx/4-4.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/dfhx/5-5.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/dfhx/6-6.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="62" height="34" src="{{ asset('/home/images/dfhx/7.jpg')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/dfhx/8-8.png')}}" alt="" /></a></li>
		</ul>
	</div>
	...
	<a style="display:none" href="javascript:void(0)" id="btn_next" class="btn showBtn"></a>
				...
				<div id="content_1_2">
					...
					<span style="font-size:24px;color:red;font-weight:600">4100/1平方</span>
				...
				<div id="content_2_1_2">
					<div id="content_2_1_2_1">
						<div index="1"  class="content1"  id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/dfhx/a1.png') }}" alt="">
						</div>
						<div index="1"  class="content1"  id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">A1户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">3室2厅2卫</span>
								
							</div>
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">121.22㎡</span>
					...
					<div  id="content_2_1_2_2">
						<div index="2" class="content1" id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/dfhx/A2.png') }}" alt="">			
						</div>
					    <div index="2" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">A2户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">3室2厅1厨2卫</span>
							</div>
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">130.10㎡</span>
							</div>
						</div>
						<div id="tu_4">
							<span style="font-size:15px;color:#f6f6f6;font-weight:500">待售</span>
					...
					<div  id="content_2_1_2_3">
						<div index="3" class="content1" id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/dfhx/B1.png') }}" alt="">
						</div>
						<div index="3" class="content1" id="tu_2_1">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">B1户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">3室2厅1厨2卫</span>
							...
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">133.31㎡</span>
					...
					<div id="content_2_1_2_4">
						<div index="4" class="content1"  id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/dfhx/B2.png') }}" alt="">	
						</div>
						<div index="4" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">B2户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">3室2厅1厨2卫</span>
							...
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">130.23㎡</span>
					...
					<div   id="content_2_1_2_5">
						<div index="5" class="content1" id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/dfhx/E1-1.png') }}" alt="">			
						</div>
					    <div index="5" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">E1-1户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">1室2厅2卫</span>
							</div>
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">121.22㎡</span>
							</div>
					...
					<div   id="content_2_1_2_6">
						<div index="6" class="content1" id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/dfhx/E1-2.png') }}" alt="">			
						</div>
					    <div  index="6" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">E1-2户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">2室2厅2卫</span>
							</div>
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">121.2㎡</span>
							</div>
						</div>
						<div id="tu_4">
							<span style="font-size:15px;color:#f6f6f6;font-weight:500">待售</span>
					...
					<div  id="content_2_1_2_6">
						<div index="7" class="content1"  id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/dfhx/E1-3.png') }}" alt="">			
						</div>
					    <div index="7" class="content1"  id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">E1-3户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">3室2厅2卫</span>
