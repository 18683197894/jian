	...
	<a style="display:none" href="javascript:void(0)" id="btn_next" class="btn showBtn"></a>
		...
		<div id="xuan">
			<div class="content_1" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" srcc="{{ asset('./home/images/hfhx/x1.png') }}" src="{{ asset('./home/images/hfhx/x1.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_2" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" srcc="{{ asset('./home/images/hfhx/x2.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_3" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" srcc="{{ asset('./home/images/hfhx/x3.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_4" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" srcc="{{ asset('./home/images/hfhx/x4.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_5" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" srcc="{{ asset('./home/images/hfhx/x5.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_6" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" srcc="{{ asset('./home/images/hfhx/x6.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_7" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" srcc="{{ asset('./home/images/hfhx/x7.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
