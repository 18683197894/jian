...
@section('css')
	<style>
		...
		#content_img_1{
			...
			background-image:url(./home/images/hfhx/logo.png);
...
@section('content')
	...
	<ul id="pic_list">
        ...
        <a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/1.png')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/2.png')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/3.png')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/4.png')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/5.png')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/6.png')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/7.png')}}" alt="" /></a></li>
		<li><a href="#"><img width="750" height="430" src="{{ asset('/home/images/hfhx/8.png')}}" alt="" /></a></li>
	</ul>
	...
	<div id="ico_list">
		<ul>
			<li class="active"><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/hfhx/1-1.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/hfhx/2-2.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/hfhx/3-3.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/hfhx/4-4.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/hfhx/5-5.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/hfhx/6-6.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="62" height="34" src="{{ asset('/home/images/hfhx/7-7.png')}}" alt="" /></a></li>
			<li><a href="javascript:void(0)"><img width="64" height="40" src="{{ asset('/home/images/hfhx/8-8.png')}}" alt="" /></a></li>
		</ul>
	</div>
	...
	<a style="display:none" href="javascript:void(0)" id="btn_next" class="btn showBtn"></a>
				...
				<div id="content_1_2">
					...
					<span style="font-size:24px;color:red;font-weight:600">10680/1平方</span>
					...
					<div style="padding-top:12px">
						<span style="font-size:16px;color:#848484">物业类型:&nbsp;洋房别墅</span>
					</div>
					<div style="padding-top:12px;position: relative;">
						<span style="font-size:16px;color:#848484">楼盘地址:&nbsp;宜屏快速通道4.5公里处</span><div style="position: absolute;right:25px;bottom:6px" class="pin icon"></div>
					</div>
				...
				<div id="content_2_1_2">
					<div id="content_2_1_2_1">
						...
						<div index="1"  class="content1"  id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">双拼一户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">4室2厅3卫</span>
								
							</div>
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">186.65㎡</span>
					...
					<div  id="content_2_1_2_2">
					    ...
					    <div index="2" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">双拼二户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">5室2厅3卫</span>
							</div>
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">186.67㎡</span>
							</div>
						</div>
						<div id="tu_4">
							<span style="font-size:15px;color:#f6f6f6;font-weight:500">待售</span>
					...
					<div  id="content_2_1_2_3">
						...
						<div index="3" class="content1" id="tu_2_1">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">联排一B户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">4室2厅3卫</span>
							...
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">155.55㎡</span>
					...
					<div id="content_2_1_2_4">
						...
						<div index="4" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">联排一A户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">4室2厅3卫</span>
					...
					<div   id="content_2_1_2_5">
						<div index="5" class="content1" id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/hfhx/hu5.png') }}" alt="">			
						</div>
					    <div index="5" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">联排二A户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">4室2厅3卫</span>
							...
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">145.94㎡</span>
							</div>
						</div>
						<div id="tu_4">
							<span style="font-size:15px;color:#f6f6f6;font-weight:500">待售</span>
					...
					<div   id="content_2_1_2_6">
						<div index="6" class="content1" id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/hfhx/hu6.png') }}" alt="">			
						</div>
					    <div  index="6" class="content1" id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">联排二B户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">4室2厅3卫</span>
					...
					<div  id="content_2_1_2_6">
						<div index="7" class="content1"  id="tu_1">
							<img style="width:100%;height:100%" src="{{ asset('home/images/hfhx/hu7.png') }}" alt="">			
						</div>
					    <div index="7" class="content1"  id="tu_2">
							<span style="font-size:18px;font-weight:500;color:#f6f6f6">独栋一户型</span>
						</div>
						<div id="tu_3">
							<div id="tu_3_1">
								<span style="font-size:16px;font-weight:500;color:#666">5室3厅3卫</span>
							</div>
							<div id="tu_3_2">
								<span style="font-size:16px;font-weight:500;color:#666">241.76㎡</span>
							</div>
						</div>
						<div id="tu_4">
							<span style="font-size:15px;color:#f6f6f6;font-weight:500">待售</span>
		...
		<div id="xuan">
			<div class="content_1" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" src="{{ asset('./home/images/hfhx/x1.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_2" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" src="{{ asset('./home/images/hfhx/x2.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_3" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" src="{{ asset('./home/images/hfhx/x3.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_4" id="content_2_2">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" src="{{ asset('./home/images/hfhx/x4.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_5" id="content_2_2">
				<div id="content_2_1_1">
					<div id="content_2_1_1_1">
						<div id="content_2_1_1_1_1">
							<div style="width:87px;height:20px;margin-top:10px">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" src="{{ asset('./home/images/hfhx/x5.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_6" id="content_2_2">
				<div id="content_2_1_1">
					<div id="content_2_1_1_1">
						<div id="content_2_1_1_1_1">
							<div style="width:87px;height:20px;margin-top:10px">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" src="{{ asset('./home/images/hfhx/x6.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
			...
			<div style="display:none" class="content_7" id="content_2_2">
				<div id="content_2_1_1">
					<div id="content_2_1_1_1">
						<div id="content_2_1_1_1_1">
							<div style="width:87px;height:20px;margin-top:10px">
				...
				<div id="content_2_3">
					<img style="width:100%;height:100%" src="{{ asset('./home/images/hfhx/x7.png') }}" alt="">
				</div>
				<div id="content_2_4">
					<div id="xiang_1">
						<div id="xiang_1_1">
