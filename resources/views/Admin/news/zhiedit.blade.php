...
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('/jslmadmin/newslei/newszhiindex/') }}/{{ $data->pid }}"><i class="fa fa-dashboard"></i>置顶文章列表</a></li>
        <li class="active">置顶新闻修改</li>
      </ol>
    </section>
...
@endif
      ...
      @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('/jslmadmin/newslei/newszhiindex/zhiedits') }}" method="post" enctype="multipart/form-data">
				      {{ csrf_field() }}
              <div class="box-body">
