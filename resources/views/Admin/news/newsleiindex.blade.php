...
@section('content')
    <section class="content-header">
      <h1>新闻板块列表</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>新闻动态</a></li>
        <li class="active">新闻板块</li>
      </ol>
    </section>
        <div class="col-xs-12" >
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> <br>板块列表 - <a href="{{ url('/jslmadmin/newsleiadd') }}">添加板块</a></h3>
            </div>
 				@if (session('info'))
...
@if(isset($data) and count($data) > 0 )
	@foreach($data as $k => $v)
                <tr>
                  ...
                  <td style="width: 25%;text-align: center;vertical-align: middle"><a href="{{ asset('uploads/news/img/') }}/{{$v->img}}"><img src="{{ asset('uploads/news/img/') }}/{{$v->img}}" width="200px" height="100px" alt=""></a></td>
                  <td style="width: 15%;text-align: center;vertical-align: middle">{{ date("Y年m月d日",$v->time) }}</td>
                  <td style="width: 25%;text-align: center;vertical-align: middle">
                    <a href="{{ url('/jslmadmin/newsleiedit') }}/{{ $v->id }}">编辑</a>&nbsp;&nbsp;
                  	<a href="#" class="del">删除</a>&nbsp;&nbsp;
                  	<a href="{{ url('jslmadmin/newslei/newsindex/') }}/{{ $v->id }}">文章管理</a>
                  </td>
                </tr>
