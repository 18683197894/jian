...
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('/jslmadmin/newsleiindex') }}"><i class="fa fa-dashboard"></i>板块列表</a></li>
...
@endif
      ...
      @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('jslmadmin/newsleiadds') }}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
              <div class="box-body">
               
                <div class="form-group">
                  <label for="exampleInputEmail1">板块标题</label>
                  <input type="text"  name="title" value="{{ old('title') }}" class="form-control" id="exampleInputEmail1" placeholder="工艺标题">
                </div>
