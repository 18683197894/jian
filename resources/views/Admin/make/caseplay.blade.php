      ...
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12" >
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
             <form action="{{url('admin/caseplay')}}" method="get">
        <div class="row">
         <div class="col-md-2">
            ...
            <input type="text" name="key" value="{{ $request['key'] or '' }}" class="form-control">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th style="width:15%;text-align:center;">案例</th>
...
@if(isset($data) and count($data) > 0 )
	@foreach($data as $k => $v)
                <tr>
                  ...
                  <td style="text-align: center;vertical-align: middle"><a href="{{ url('/home/case/index/play/') }}/{{ $v->uid }}" target="_blank">{{ $v->title }}</a></td>
