...
@section('content')
    <section class="content-header" style="text-align:center">
      <h1>{{ $tit }} - 配置详情</h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('admin/package/all/pei') }}/{{$pid}}"><i class="fa fa-dashboard"></i>配置列表</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> <br> <a href="{{ url('/admin/package/all/pei/subadd') }}/{{ $id }}">添加子类</a></h3>
            </div>
 				@if (session('info'))
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th style="width:15%;text-align:center;">子类标题</th>
	...
	@foreach($data as $k => $v)
                <tr>
                  ...
                  <td style="text-align: center;vertical-align: middle">
                  	<a href="{{ url('admin/package/all/pei/subedit') }}/{{ $v->id }}">编辑</a>&nbsp;&nbsp;
...
@else
                <tr>
                  <td style="text-align: center;vertical-align: middle" colspan="5">未找到配置</td>
                </tr>
@endif
...
<script>
  $(".del").on('click',function(){
         ...
         $.ajax('/admin/package/all/pei/subdel',{
            type : 'post',
            data :{id:id},
