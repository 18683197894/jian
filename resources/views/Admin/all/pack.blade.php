...
@section('content')
    <section class="content-header" style="text-align:center">
      <h1>包管理</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>全包套餐</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> <br><a href="{{ url('/admin/package/all/packadd') }}/">添加套餐</a></h3>
            </div>
        @if (session('info'))
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th style="width:10%;text-align:center;">套餐名称</th>
                  <th style="width:20%;text-align:center;">套餐介绍</th>
                  <th style="width:15%;text-align:center;">包组合</th>
  ...
  @foreach($data as $k => $v)
                <tr>
                  ...
                  <td style="text-align: center;vertical-align: middle">
                    ...
                    <a href="{{ url('admin/package/all/packedit/') }}/{{ $v->id }}">编辑</a>&nbsp;&nbsp;
...
<script>
  $(".del").on('click',function(){
         ...
         $.ajax('/admin/package/all/packdel',{
            type : 'post',
            data :{id:id},
