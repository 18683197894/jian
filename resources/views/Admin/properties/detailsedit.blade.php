...
@section('content')
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        <li><a href="{{ url('admin/properties/details') }}"><i class="fa fa-dashboard"></i>动态列表</a></li>
        <li class="active">更新动态</li>
      </ol>
    </section>
...
@endif
      ...
      @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('admin/properties/detailsedits') }}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
              <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" name="pidname">
                    ...
                    <option value="项目详情" @if($data->pidname == "项目详情") selected="selected" @endif>项目详情</option>
                    <option value="万都超市" @if($data->pidname == "万都超市") selected="selected" @endif>万都超市</option>
                    <option value="产品品鉴" @if($data->pidname == "产品品鉴") selected="selected" @endif>产品品鉴</option>
