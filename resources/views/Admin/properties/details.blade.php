        ...
        <div class="row">
         <div class="col-md-2">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"><a href="{{ url('admin/properties/detailsadd') }}">添加动态</a></h3>
            </div>
              ...
              <div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  style="width: 10%; text-align:center;">标题</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  style="width: 7%; text-align:center;">父类</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  style="width: 14%; text-align:center;">创建时间</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  style="width: 20%; text-align:center;">网页标题</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  style="width: 32%; text-align:center;">网页关键字</th>
...
@section('js')
       ...
       $(".shan").on('click',function(){
        ...
        var tr = $(this).parents('tr');
         ...
         $.ajax('/admin/properties/detailsdel',{
            type:'post',
            data:{id:id},
