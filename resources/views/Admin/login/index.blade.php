...
<head>
  ...
  <title>{{ config('app.name') }} - 登入</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>建设网络平台</b></a>
  </div>
  <!-- /.login-logo -->
...
@endif
    ...
    <form action="{{ url('/jslmindex/dologin') }}" method="post">
    {{ csrf_field() }}
 ...
 form-control-feedback"></span>
      ...
      <div class="form-group has-feedback">
        <input type="password" name="mima" class="form-control" placeholder="密码">
