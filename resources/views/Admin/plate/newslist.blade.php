...
@section('content')
  ...
  <div class="box">
      ...
      @endif
            ...
            <!-- /.box-header -->
            <div class="box-body">
      <form action="{{url('admin/plate/newslist')}}/{{ $pid }}" method="get">
        <div class="row">
         <div class="col-md-2">
           
            <div class="box-header">
           
              <h3 class="box-title"><a href="{{ url('/admin/plate/newsadd') }}/{{ $pid }}">添加文章</a></h3>
            </div>
          ...
          <div class="input-group input-group-sm">
            <input type="text" name="key" value="{{ $request['key'] or '' }}" class="form-control">
              ...
              <div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  style="width: 8%; text-align:center;">所属模块</th>
...
@foreach($data as $k => $v)     
                <tr role="row" class="odd">
                  ...
                  <td style="text-align: center;vertical-align: middle"><a href="{{ url('/uploads/plate/newsimg/') }}/{{$v->titleimg }}"><img src="{{ asset('/uploads/plate/newsimg/') }}/{{$v->titleimg }}" width="170px" height="70px" alt=""></a></td>
                  ...
                  <td style="text-align: center;vertical-align: middle"><a href="{{ url('/admin/plate/newsedit') }}/{{ $v->id }}">编辑
