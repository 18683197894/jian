...
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('/admin/plate/newslist/') }}/{{ $pid }}"><i class="fa fa-dashboard"></i>文章列表</a></li>
...
@endif
      ...
      @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('admin/plate/newsadds') }}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
              <div class="box-body">
