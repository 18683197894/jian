...
@section('content')
    <section class="content-header">
      <h1>工艺列表</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>装修工艺</a></li>
        <li class="active">工艺列表</li>
      </ol>
    </section>
        <div class="col-xs-12" >
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> <br>工艺列表 - <a href="{{ url('/admin/gongyi/lei/add') }}">添加工艺</a></h3>
            </div>
 				@if (session('info'))
...
@if(isset($data) and count($data) > 0 )
	@foreach($data as $k => $v)
                <tr>
                  ...
                  <td style="width: 25%;text-align: center;vertical-align: middle"><a href="{{ asset('uploads/gongyi/img/') }}/{{$v->img}}"><img src="{{ asset('uploads/gongyi/img/') }}/{{$v->img}}" width="200px" height="100px" alt=""></a></td>
                  <td style="width: 15%;text-align: center;vertical-align: middle">{{ date("Y年m月d日",$v->time) }}</td>
                  <td style="width: 25%;text-align: center;vertical-align: middle">
                    <a href="{{ url('admin/gongyi/lei/edit') }}/{{ $v->id }}">编辑</a>&nbsp;&nbsp;
                  	<a href="#" class="del">删除</a>&nbsp;&nbsp;
                  	<a href="{{ url('admin/gongyi/lei/newslist/') }}/{{ $v->id }}">工艺文章管理</a>
                  </td>
                </tr>
