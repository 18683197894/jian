...
class PropertiesController extends Controller
{
    ...
    public function detailsadds(Request $request)
    {
    	...
    	if( $res ){
    		return "添加成功：<a href='/admin/properties/detailsadd'>继续添加</a> &nbsp;&nbsp;<a href='/jslmadmin/index'>返回首页</a>";
    	}else
    	{
    ...
    public function hfnewsadds(Request $request)
    {
        ...
        if( $res ){
            return "添加成功：<a href='/admin/properties/hfnewsadd'>继续添加</a> &nbsp;&nbsp;<a href='/jslmadmin/index'>返回首页</a>";
        }else
        {
            return back()->withInput()->with(['info'=>'数据库写入失败']);
        }
