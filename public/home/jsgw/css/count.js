var __cc_sys_url = "http://im.28.com.cn/Counter/";
/*
...
//	+ '<img src="'+__cc_count+'" width='+__cc_style+' height='+__cc_style+' alt="网商宝流量统计" border=0>'
//	+ '</a>');

document.write('<a href="http://im.28.com.cn" target="_blank">'
	+ '<img src="' + __cc_count + '" width=50 height=12 alt="http://im.28.com.cn" border=0>'
	+ '</a>');
